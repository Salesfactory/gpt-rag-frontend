...
describe("Agent Section Tests", () => {
   ...
   it('Should verify the visibility and functionality of the "Workspace Governance Page" link', () => {
        ...
        cy.contains("label", "Brand Description")
            .parent()
            .find("textarea")
            .clear()
            .type(updatedData.brandInformation);
          
        // Edit Business Description
        cy.contains("label", "Business Description")
            .parent()
            .find("textarea")
            .clear()
            .type(updatedData.industryInformation)
          
        // Edit Additional Instructions
        cy.contains("label", "Additional Instructions")
            .parent()
            .find("textarea")
            .clear()
            .type(updatedData.additionalInstructions)
          
        // Edit Segment Aliases
        cy.contains("label", "Segment Aliases")
            .parent()
            .find("textarea")
            .clear()
            .type(updatedData.segmentSynonyms);
        ...
        cy.wait("@updateOrg").then((interception) => {
            ...
            expect(interception.request.body).to.deep.equal(updatedData);
          });
    });
});