...
describe("Voice Customer Test Suite", () => {
    ...
    it("Should verify the functionality of the product creation", () => {
        cy.url().should("include", "#/voice-customer");
        cy.get('[aria-label="create-product-button"]').should("be.visible");
        cy.get('[aria-label="create-product-button"]').click();
    ...
    it("Should verify the functionality of the competitor creation", () => {
        cy.url().should("include", "#/voice-customer");
        cy.get('[aria-label="create-competitor-button"]').should("be.visible");
        cy.get('[aria-label="create-competitor-button"]').click();
