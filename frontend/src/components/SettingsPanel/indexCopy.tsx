    ...
    const handleSubmit = () => {
        ...
        postSettings({
            ...
            .then(data => {
                ...
                const normalized: DetailLevel = returned === "brief" || returned === "balanced" || returned === "detailed" ? returned : detailLevel;
                    ...
                    <Stack.Item grow className={styles["w-100"]}>
                        ...
                        {loading ? (
                            ...
                            <div className={styles.content}>
                                ...
                                <div role="group" aria-label="Detail Level" className={styles.segmentedGroup} data-testid="detail-level-group">
                                    <div
