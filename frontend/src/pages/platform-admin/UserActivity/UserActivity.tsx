...
import { getUserActivity, UserActivity } from '../../../services/platform-admin/userActivityService.mock';
import { organizationService } from '../../../services/platform-admin/organizationService.mock';
import { Organization } from '../../../services/platform-admin/mockData';
          ...
          <Stack horizontal tokens={{ childrenGap: 12 }} wrap>
            ...
            <Stack.Item grow={1} styles={{ root: { minWidth: 150 } }}>
              <TextField
                ...
                type="date"
                value={startDate}
                onChange={(_, newValue) => setStartDate(newValue || '')}
              />
            </Stack.Item>
            ...
            <Stack.Item grow={1} styles={{ root: { minWidth: 150 } }}>
              <TextField
                ...
                type="date"
                value={endDate}
                onChange={(_, newValue) => setEndDate(newValue || '')}
              />
            </Stack.Item>
        ...
        >
          {isLoading ? (
            ...
            >
              <Icon
                iconName="People"
                styles={{ root: { fontSize: 48, color: theme.palette.neutralTertiary } }}
              />
