    ...
    return (
        <div className={styles.page_container}>
            <div className={styles.labelContainer}>
                <button className={styles.button} title="Return to Summarization Reports" aria-label="Return to Summarization Reports" onClick={() => navigate('/summarization-reports')}>
            ...
            <div id="options-row" className={styles.row}>
                <h1 className={styles.title}>Summarization Report Creation</h1>
            </div>
            <div className={styles.card}>
                <div>
                    <form>
                        ...
                        <Dropdown placeholder="Select a Summarization Report Type" options={summarizationReportOptions} onChange={handleTypeDropdownChange} defaultValue={typeSelection} responsiveMode={ResponsiveMode.unknown}/>
                    </form>
                </div>
                <div>
            ...
            {isConfirm && (
                <div className={styles.modal}>
                    ...
                    <Label className={styles.text}>Are you sure you want to create the report {inputReportTicker} + {typeSelection} ?</Label>
            ...
            {isPopupActive && (
                <div className={styles.modalPopup}>
                    <Label className={styles.text}>The custom report has been added. <br />It needs to be implemented for generation. <br /> 
